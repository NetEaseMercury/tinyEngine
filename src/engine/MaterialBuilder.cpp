...
void MaterialBuilder::init(Parameters parameters)
{
	...
	*/
	...
	forwardPassParams.shaderPaths[VK_SHADER_STAGE_VERTEX_BIT] = "res/shaders/vert.spv";
	forwardPassParams.shaderPaths[VK_SHADER_STAGE_FRAGMENT_BIT] = "res/shaders/frag.spv";
