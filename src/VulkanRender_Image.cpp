/**
 * @file VulkanRender_Image.cpp
 * @brief Texture/normal images, views, sampler, buffer↔image copy, layout transitions.
 */
...
/** @brief Load albedo with stb_image, staging→GPU image, shader read layout */
...
/** @brief Same path as albedo pipeline for normal map image (RGBA) */
...
/** @brief ImageView for textureImage (sampled in fragment shader) */
void VulkanRender::createTextureImageView()
{
	textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT);
}

/** @brief Generic 2D image + device memory bind */
void VulkanRender::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling,
...
/** @brief Pipeline barrier for UNDEFINED→TRANSFER_DST or TRANSFER_DST→SHADER_READ */
...
/** @brief Linear sampler with anisotropy for albedo sampling */
